...
padding: "6px 10px",
borderRadius: 999,
border: "1px solid rgba(10,27,58,0.14)",
background: "rgba(255,255,255,0.60)",
fontSize: 12,
color: "rgba(10,27,58,0.82)",
fontWeight: 650,
}}
>
{text}
...
const json = (await res.json()) as { ok: boolean; total?: number; share?: number };
...
{livePct && liveN !== null ? (
<>
<b>{livePct}</b> of users match your archetype (n={liveN.toLocaleString()}).
</>
) : (
<>Loading live stats…</>
)}
...
<button className="btn" onClick={() => { setUnlocked(false); setUnlockedState(false); }}>
Lock (dev)
</button>
